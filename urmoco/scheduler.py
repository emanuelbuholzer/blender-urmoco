...
class Scheduler:
    ...
    def start_dfmoco_server(self, config):
        ...
        if self.df_server_proc is None:
            ...
            logger.info(f"DFMoco server process already running with PID {self.df_server_proc.pid}")
    ...
    def start_backend(self, config):
        ...
        if self.backend_proc is None:
            ...
            logger.info(f"Backend process already running with PID {self.backend_proc.pid}")
